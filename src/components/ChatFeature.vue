...
<div>
  ...
  <div class="send-msg-pop animated fast" v-bind:class="[togglePop ? 'slideInUp' : 'slideOutDown']">
    <div class="chat-footer">
      ...
      <div class="send-btn">
        <img src="../assets/img/more.png" alt="" v-on:click="onTogglePop()">
      </div>
    </div>

    <div>
      <ul>
        <li v-for="(item, index) in rightDatas" v-bind:key="index" @click="onRightSelectMsg(item)">
          {{item.rightMsg[0]}}
        </li>
      </ul>
    </div>
